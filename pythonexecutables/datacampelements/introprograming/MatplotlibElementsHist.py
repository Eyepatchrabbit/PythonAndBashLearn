...
# Histograms
# =>Show how a variable is spread out by dividing into bins
histlist = [43.828, 76.423, 72.301, 42.731, 75.32, 81.235, 79.829, 75.635, 64.062, 79.441, 56.728, 65.554, 74.852,
...
plt.hist(histlist)  # default->10 bins
plt.show()
plt.clf() #cleans plot up again so you can start afresh.

plt.hist(histlist,bins=4) #control the number of bins to divide your data in
plt.show()
plt.clf()
